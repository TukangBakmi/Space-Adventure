...
public class ShopPage2 extends World
{
    MaxCrystal soldOut = new MaxCrystal();
    BotLeft button = new BotLeft();
    ...
    {
        ShopPage1.shopPage = 2;
        addObject(soldOut, 325,452);
        soldOut.getImage().setTransparency(0);
    ...
    private void maxLevel()
    {
        if(Item.crystal >= 1)
        {
            soldOut.getImage().setTransparency(255);
            removeObject(button);
        }
    }
}